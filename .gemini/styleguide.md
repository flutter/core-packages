# Flutter Core Packages Style Guide
...
Code should follow the [Flutter style guide](https://github.com/flutter/flutter/blob/master/docs/contributing/Style-guide-for-Flutter-repo.md),
and use the Dart auto-formatter.
...
- PR descriptions should include the Pre-Review Checklist from
  [the PR template](https://github.com/flutter/core-packages/blob/main/.github/PULL_REQUEST_TEMPLATE.md),
