...
class Colors {
  ...
  /// RGBA values for the named CSS color 'cornsilk'.
  ...
  /// RGBA values for the named CSS color 'forestgreen'.
  ...
  /// RGBA values for the named CSS color 'lightcoral'.
  ...
  /// RGBA values for the named CSS color 'lightgoldenrodyellow'.
  ...
  /// RGBA values for the named CSS color 'lightsteelblue'.
  static Vector4 get lightSteelBlue =>
      Vector4(176.0 / 255.0, 196.0 / 255.0, 222.0 / 255.0, 255.0 / 255.0);

  /// RGBA values for the named CSS color 'lightyellow'.
  ...
  /// RGBA values for the named CSS color 'moccasin'.
  ...
  /// RGBA values for the named CSS color 'saddlebrown'.
