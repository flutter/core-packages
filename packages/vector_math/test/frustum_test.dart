...
void testFrustumIntersectsWithSphere() {
  ...
  expect(
    frustum.intersectsWithSphere(Sphere.centerRadius($v3(0.0, 0.0, 0.0), 0.0)),
    isFalse,
  );
  expect(
    frustum.intersectsWithSphere(Sphere.centerRadius($v3(0.0, 0.0, 0.0), 0.9)),
    isFalse,
  );
  expect(
    frustum.intersectsWithSphere(Sphere.centerRadius($v3(0.0, 0.0, 0.0), 1.1)),
    isTrue,
  );
  expect(
    frustum.intersectsWithSphere(
      Sphere.centerRadius($v3(0.0, 0.0, -50.0), 0.0),
    ),
    isTrue,
  );
  expect(
